...
if __name__ == "__main__":
    ...
    fhipath=["/home/adam/software-apps/FHIaims_genericELPA_modded","/home/lacoxson/software/FHIaims_modded"][1]
    ...
    maindir=["/home/adam/work/FHI-aims/agrav_soc/soc_tests","/home/lacoxson/work/fhi-tutorial/fhi-soc-testing"][1]
    # Run or skip the relaxation calculation
    skip_relaxation = False
    run_command = f"mpirun -n {num_cores} "+fhipath+"/build/aims.260530.scalapack.mpi.x > aims.out 2>&1"


    relax_dir = maindir+"/graphene_monolayer_unitcell/relaxation_light"
    soc_dir = maindir+"/graphene_monolayer_unitcell/soc_intermediate"
    nosoc_dir = maindir+"/graphene_monolayer_unitcell/nosoc_intermediate"
    ...
    atoms = build_monolayer_graphene((1,1,1))
